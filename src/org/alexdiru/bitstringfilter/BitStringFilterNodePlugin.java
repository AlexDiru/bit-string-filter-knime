 ...
 */
public class BitStringFilterNodePlugin extends Plugin {
    // The shared instance.
    private static BitStringFilterNodePlugin plugin;

    /**
     * The constructor.
     */
    public BitStringFilterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BitStringFilterNodePlugin getDefault() {
        return plugin;
    }
